...
[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/Rishvan/FlashPBot.git:/)

### The Hard Method(Not Supported for this version!!)
```js
$ git clone https://github.com/Rishvan/FlashPBot.git
